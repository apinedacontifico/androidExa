    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Estas en main_activity", Snackbar.LENGTH_LONG)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Toast.makeText(MainActivity.this,
                    "Camera option", Toast.LENGTH_LONG).show();
            ...
            Log.d("mensaje", "beforef1");
            getSupportFragmentManager().beginTransaction().replace(R.id.frame_container, new BlankFragment1()).commit();
            //Log.d("mensaje", "afterf1");
            ...
            Toast.makeText(MainActivity.this,
                    "Manage option", Toast.LENGTH_LONG).show();
        } else if (id == R.id.nav_share) {
            Toast.makeText(MainActivity.this,
                    "Share option", Toast.LENGTH_LONG).show();
        } else if (id == R.id.nav_send) {
            Toast.makeText(MainActivity.this,
                    "Send option", Toast.LENGTH_LONG).show();
        }
